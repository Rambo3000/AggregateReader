...
DefaultDirName={localappdata}\AggregateReader
PrivilegesRequired=none
OutputBaseFilename=AggregateReaderInstaller-{#MyAppVersion}
...
SetupIconFile=..\..\Resources\tree-view.ico 
...
Source: "..\..\bin\Release\net10.0-windows\win-x64\publish\AggregateReader.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\AggregateReader"; Filename: "{app}\AggregateReader.exe"
Name: "{userdesktop}\AggregateReader"; Filename: "{app}\AggregateReader.exe"; Tasks: desktopicon

[Tasks]
Name: desktopicon; Description: "Create a desktop icon"; GroupDescription: "Additional icons:"; Flags: unchecked

[Run]
Filename: "{app}\AggregateReader.exe"; Description: "Launch AggregateReader"; Flags: nowait postinstall skipifsilent